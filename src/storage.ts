...
const [initial]=useState(()=>{try{return readSavedFeedback(localStorage.getItem(key));}catch{return {items:seed,warning:'Browser storage is unavailable. Changes work for this session only.',blocked:false};}});
